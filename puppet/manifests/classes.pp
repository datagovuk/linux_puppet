...
class dgu_users {
  ...
  beluga::user {'skemp':
    uid => 5019,
    groups => ['admins'],
    ssh_key => '',
    key_type => 'ssh-rsa',
  }
  ...
  beluga::user {'mpoland':
    uid => 5020,
    groups => ['admins'],
    ssh_key => '',
    key_type => 'ssh-rsa',
  }
